...
class RNNDecoder(tf.keras.Model):
    ...
    def __init__(self, vocab_size, embedding_dim, units, attention="additive"):
        ...
        self.gru = tf.keras.layers.GRU(units, return_state=True, return_sequences=True)
        self.attention = BahdanauAttention(units)
        
        self.fc1 = tf.keras.layers.TimeDistributed(tf.keras.layers.Dense(units, activation='relu'))
